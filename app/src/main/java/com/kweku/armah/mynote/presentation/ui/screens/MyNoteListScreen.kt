...
import com.kweku.armah.mynote.presentation.ui.navigation.NavRoutes
import com.kweku.armah.mynote.presentation.viewmodel.MyNoteViewModel

// It is good to split the navigation graph just as you split the screen,
// using the following approach
@OptIn(ExperimentalLifecycleComposeApi::class)
fun NavGraphBuilder.navigateToMyNoteListScreen(navigateToScreen: (String) -> Unit) {
